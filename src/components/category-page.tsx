    ...
    <div className="min-h-screen bg-zinc-100 text-zinc-900">
      ...
      <main className="mx-auto max-w-7xl px-6 py-10">
        <div className="rounded-3xl border border-zinc-300 bg-white p-8 shadow-sm">
          <h2 className="text-4xl font-bold text-zinc-950">{title}</h2>
          ...
          <section className="mt-8">
            <h3 className="text-2xl font-bold text-zinc-950">Featured in this category</h3>
          ...
          <section className="mt-8 rounded-2xl border border-zinc-300 bg-zinc-50 p-6">
            <h3 className="text-2xl font-bold text-zinc-950">How to use these tools</h3>
